...
This will generate a migration file as well as a model called BuddyMapper.
...
* Add tests for it. This is important so I don't break it in a future version unintentionally (acts_as_buddy uses Shoulda and Dummier)
